...
//builder.Services.AddDbContext<ContactsAPIDbContext>(options => options.UseNpgsql(builder.Configuration.GetConnectionString("ContactsApiConnectionString")));
//builder.Services.AddDbContext<ContactsAPIDbContext>(
//                    o => o.UseNpgsql(builder.Configuration.GetConnectionString("ContactsApiConnectionString"))
//    );
